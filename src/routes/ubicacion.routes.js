...
import {
  crearUbicacionEsquema,
  editarUbicacionEsquema,
} from "../validations/ubicacion.validation.js";
...
router.post(
  "/",
  upload.single("foto"),
  validarEsquema(crearUbicacionEsquema),
  crearUbicacion,
);
router.put(
  "/:id",
  upload.single("foto"),
  validarEsquema(editarUbicacionEsquema),
  editarUbicacion,
);
